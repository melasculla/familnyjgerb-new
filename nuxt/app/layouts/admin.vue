   ...
   <div
      ...
      <div class="flex gap-2 sm:gap-8 items-center flex-wrap px-2 py-2 border-b-[5px] border-title">
         <NuxtLink :to="localPath('/')">
            <div class="icon size-12 sm:size-14 block"
               :style="`mask:url(/icons/admin/home.svg) no-repeat center / contain;`">
            </div>
         </NuxtLink>
               ...
               <ul class="grid gap-3 divide-y-4 divide-fill">
                  <li v-for="page in pages" class="pt-2 px-3 text-center">
                     <NuxtLink :to="localPath(page.path)" class="flex items-center icon-parent">
                        ...
                        <div class="icon block size-10 ml-auto"
                           :style="`mask:url(${page.icon}) no-repeat center / contain`" />
                     </NuxtLink>
                  </li>
               </ul>
            </nav>
